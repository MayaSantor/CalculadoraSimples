...
b1 = Button(frame_corpo,command=limpar, text="C", width=11, height=2, bg=cor2, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b1.place(x=0,y=0)
...
b2.place(x=118,y=0)
b3 = Button(frame_corpo, command=lambda:entrar_valores('/'), text="/", width=5, height=2, bg=cor3, fg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b3.place(x=177,y=0)
...
b6.place(x=118,y=52)
b7 = Button(frame_corpo, command=lambda:entrar_valores('*'), text="*", width=5, height=2, bg=cor3, fg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b7.place(x=177,y=52)
...
b11 = Button(frame_corpo, command=lambda:entrar_valores('-'), text="-", width=5, height=2, bg=cor3, fg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b15 = Button(frame_corpo, command=lambda:entrar_valores('+'), text="+", width=5, height=2, bg=cor3, fg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b17 = Button(frame_corpo, command=calcular, text="=", width=5, height=2, bg=cor3, fg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
